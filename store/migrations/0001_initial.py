# Generated by Django 3.2.8 on 2021-12-15 17:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.CharField(choices=[('HOKA', 'Hoka'), ('NIKE', 'Nike'), ('ADIDAS', 'Adidas'), ('BROOKS', 'Brooks'), ('ASICS', 'ASICS'), ('NEW_BALANCE', 'New Balance'), ('SAUCONY', 'Saucony')], max_length=20)),
                ('type', models.CharField(choices=[('EVERYDAY', 'Everyday'), ('LIGHTWEIGHT', 'Lightweight'), ('RACING', 'Racing')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
